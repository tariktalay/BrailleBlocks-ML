...
blocks_dataset = dataset_base.copy({
  'name': 'Blocks dataset',
  'train_info': '/content/drive/MyDrive/Braille Blocks/annotations/instances_default_TRAİN.json',
  'train_images': '/content/drive/MyDrive/Braille Blocks/Train/',
  'valid_info': '/content/drive/MyDrive/Braille Blocks/annotations/instances_default_VAL.json',
  'valid_images': '/content/drive/MyDrive/Braille Blocks/Val/',
  'class_names': ('block'),
  'has_gt': True,
  'label_map': { 1:1}
})
...
yolact_resnet101_blocks_config = yolact_resnet101_config.copy({
    'name': 'yolact_plus_resnet101_block',
    # Dataset stuff
    'dataset': blocks_dataset,
    'num_classes': len(blocks_dataset.class_names) + 1,
